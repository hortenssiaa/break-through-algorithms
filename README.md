...
###### 1.2.7.2 conditional expression 조건부 표현식
```python
...
###### 1.2.7.3 리스트에 있는 원소의 값을 변경해서, 또 다른 리스트를 만들고자 할때
```python
a = [1, 2, 3, 4, 5]
remove = [3, 5]
...
###### 1.2.10.2 더 빠른 코드 - sys.stdin.readline()
